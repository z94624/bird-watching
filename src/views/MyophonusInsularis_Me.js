			...
			<div className="col-md-9 px-5 text-white">
				...
				<div className="row my-5">
					...
					<div id="abMeResume" className="col-md-4 col-lg-6 d-flex justify-content-start align-items-center p-3">
						<a id="abMeResumeButton" className="btn btn-outline-info btn-lg" href="https://www.cakeresume.com/s--q29BJ9LppPuaALpKuU9U4A--/smobee" target="_blank" rel="noopener noreferrer" role="button">
